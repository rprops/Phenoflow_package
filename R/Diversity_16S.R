...
#'
#' This function calculates Hill diversity metrics from 16S rRNA gene amplicon data (in phyloseq format).
...
#' Additionally, similarity-sensitive D0, D1 and D2 (Leinster and Cobbold 2012) can 
#' be calculated by supplying an optional similarity matrix. If the phyloseq object 
#' contains a phylogenetic tree and the similarity matrix argument is NULL, the similarity
...
#' frequencies.
#' @param simmat distance matrix (symmetric) with the number of OTUs/taxa in each dimension. Defaults to NULL.
