---
title: "The effect of sample size"
...
```{r prepPhenoFlow, fig.width=7,fig.height=5, message=FALSE}
library("Phenoflow")
library("gridExtra")
library("grid")
library(ggplot2)
...
```{r subsamplecollcurves, results='hide',fig.width=7,fig.height=5,fig.cap=c("D0 collector curve","D1 collector curve","D2 collector curve")}
...
```{r arranged plots, fig.width=8,fig.height=5}
